...
(function (name, context, factory) {
  // Supports UMD. AMD, CommonJS/Node.js and browser context
  if ( true && module.exports) {
    module.exports = factory(__webpack_require__(/*! heatmap.js */ "./node_modules/heatmap.js/build/heatmap.js"), __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'google-maps'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())));
  } else if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! heatmap.js */ "./node_modules/heatmap.js/build/heatmap.js"), !(function webpackMissingModule() { var e = new Error("Cannot find module 'google-maps'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
  ...
  var HeatmapOverlay = function HeatmapOverlay(map, cfg) {
    this.setMap(map);
    this.initialize(cfg || {});
  };
...
/***/ 4:
/*!*********************************************!*\
  !*** multi ./resources/js/gmaps-heatmap.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! c:\SERVER\domains\mysite\resources\js\gmaps-heatmap.js */"./resources/js/gmaps-heatmap.js");
